...
aws elasticbeanstalk create-application-version --application-name bc-dev-hot --version-label $TRAVIS_COMMIT --source-bundle S3Bucket=$EB_BUCKET,S3Key=mm-prod-deploy.zip
